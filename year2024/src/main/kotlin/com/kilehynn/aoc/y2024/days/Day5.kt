...
class Day5 :  BaseDay() {
    ...
    override var expectedPart1 :Long? = 6505L
    override var expectedPart2 :Long? = 6897L

    override fun parse(input: String) {
        val sections =
            input.split(System.lineSeparator().repeat(2).toRegex()).toList()
    ...
    fun isUpdateValid(update: List<Int>): Boolean {
        ...
        return update.stream().allMatch { page: Int ->
            ...
            dependencies.stream().allMatch { dependency: Int ->
                pageUpdated[dependency] == null || pageUpdated.getOrDefault(
                    dependency,
                    true
                )
            }
